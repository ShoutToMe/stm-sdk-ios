#ifndef Stm_STMCvad_h
#define Stm_STMCvad_h
 ...
 */
void stm_wv_detector_cvad_update_ref_levels(stm_s_wv_detector_cvad_state *cvad_state, double *band_energy, double dfc, double sfm);
